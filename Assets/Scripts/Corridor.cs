...
namespace YourGameNamespace
{
    ...
    {
        public HashSet<Vector3Int> CorridorTiles { get; private set; }
        public Room RoomA { get; private set; }
        public Room RoomB { get; private set; }

        // Constructor
        public Corridor(HashSet<Vector3Int> corridorTiles, Room roomA, Room roomB)
        {
            CorridorTiles = new HashSet<Vector3Int>(corridorTiles); // Ensure no unintended reference issues
            RoomA = roomA;
            RoomB = roomB;
        }
        ...
        /// </summary>
        public bool IsTilePartOfCorridor(Vector3Int tile)
        {
